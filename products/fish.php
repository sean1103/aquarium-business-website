...
<h1 style="color: white;">🐠 海水魚販售區</h1>

<div class="fish-grid">
  <?php
  $fishes = [
    ["img" => "../asses/fishs/f1.png", "name" => "藍眼黃新娘神仙魚", "size" => "8cm", "price" => "$2200"],
    ["img" => "../asses/fishs/f3.png", "name" => "藍倒吊", "size" => "12cm", "price" => "$1000"],
    ["img" => "../asses/fishs/f2.png", "name" => "小丑魚", "size" => "5cm", "price" => "$150"],
    ["img" => "../asses/fishs/f4.png", "name" => "青蛙魚", "size" => "6cm", "price" => "$200"],
    ["img" => "../asses/fishs/f5.png", "name" => "砲彈魚", "size" => "8cm", "price" => "$300"],
    ["img" => "../asses/fishs/f6.png", "name" => "蝦虎魚", "size" => "4cm", "price" => "$200"],
    ["img" => "../asses/fishs/f7.png", "name" => "澳洲神仙魚", "size" => "15cm", "price" => "$6000"],
    ["img" => "../asses/fishs/f8.png", "name" => "隆頭魚", "size" => "8cm", "price" => "$150"],
    ["img" => "../asses/fishs/f9.png", "name" => "蝴蝶魚", "size" => "7cm", "price" => "$250"],
    ["img" => "../asses/fishs/f10.png", "name" => "泗水玫瑰魚", "size" => "3cm", "price" => "$200"],
  ];
